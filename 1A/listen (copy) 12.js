...
url: (await global.nodemodule["axios"]('https://sex.accountkz.co/cosplay')).data.url,
method: "GET",
responseType: "stream"
})).data                                      },event.threadID);
