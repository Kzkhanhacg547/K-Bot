...
(async function () {
	...
	logger(`${api.getCurrentUserID()} - 『 ${global.config.PREFIX} 』 • ${(!global.config.BOTNAME) ? "𝐊𝐳 𝐁𝐨𝐭" : global.config.BOTNAME}`, "『 BOT INFO 』");
...
『📌』→𝐁𝐎𝐗 𝐓𝐈𝐃: ${event.threadID}\n『📝』→Đ𝐞̂̉ 𝐠𝐮̛̉𝐢 𝐲𝐞̂𝐮 𝐜𝐚̂̀𝐮 𝐝𝐮𝐲𝐞̣̂𝐭, 𝐝𝐮̀𝐧𝐠: ${prefix}request`, event.threadID);
    };
    switch (event.type) {
